...
<!DOCTYPE html>
<html lang="en">
<?php $site = "lecturer_change_login.php?logout='1'"; include 'lecturer_header.php';?>

	<main class="row">
  <section class="col-md-10 col-xs-offset-1 col-xs-10">
    <h3><center>Change Login Details</center></h3>
    <form method="post" action="lecturer_change_login.php" class = "form-group">
...
<input type="submit" class="btn" style="margin-top: 10px;" name="change_login" value="Change"/>
